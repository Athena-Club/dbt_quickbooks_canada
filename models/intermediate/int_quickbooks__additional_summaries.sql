...
total_revenue as (
    select
        ...
        cast('Amount sum 5' as {{ dbt_utils.type_string() }}) as account_class,
        cast('income_statement' as {{ dbt_utils.type_string() }}) as financial_statement_helper,
        cast({{ dbt_utils.date_trunc("year", "period_first_day") }} as date) as date_year,
        cast(period_first_day as date) as period_first_day,
        {{ dbt_utils.last_day("period_first_day", "month") }} as period_last_day,
...
total_cost_of_goods_sold as (
    select
        ...
        cast('Amount sum 6' as {{ dbt_utils.type_string() }}) as account_class,
        cast('income_statement' as {{ dbt_utils.type_string() }}) as financial_statement_helper,
        cast({{ dbt_utils.date_trunc("year", "period_first_day") }} as date) as date_year,
        cast(period_first_day as date) as period_first_day,
        {{ dbt_utils.last_day("period_first_day", "month") }} as period_last_day,
...
total_expenses as (
    select
        ...
        cast('Amount sum 7' as {{ dbt_utils.type_string() }}) as account_class,
        cast('income_statement' as {{ dbt_utils.type_string() }}) as financial_statement_helper,
        cast({{ dbt_utils.date_trunc("year", "period_first_day") }} as date) as date_year,
        cast(period_first_day as date) as period_first_day,
        {{ dbt_utils.last_day("period_first_day", "month") }} as period_last_day,
...
total_other_income as (
    select
        ...
        cast('TOTAL OTHER IfullNCOME' as {{ dbt_utils.type_string() }})as account_sub_type,
        cast('Amount sum 8' as {{ dbt_utils.type_string() }}) as account_class,
        cast('income_statement' as {{ dbt_utils.type_string() }}) as financial_statement_helper,
        cast({{ dbt_utils.date_trunc("year", "period_first_day") }} as date) as date_year,
        cast(period_first_day as date) as period_first_day,
        {{ dbt_utils.last_day("period_first_day", "month") }} as period_last_day,
...
total_other_expenses as (
    select
        ...
        cast('Amount sum 9' as {{ dbt_utils.type_string() }}) as account_class,
        cast('income_statement' as {{ dbt_utils.type_string() }}) as financial_statement_helper,
        cast({{ dbt_utils.date_trunc("year", "period_first_day") }} as date) as date_year,
        cast(period_first_day as date) as period_first_day,
        {{ dbt_utils.last_day("period_first_day", "month") }} as period_last_day,
